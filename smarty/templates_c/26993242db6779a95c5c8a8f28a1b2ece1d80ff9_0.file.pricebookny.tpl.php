<?php
/* Smarty version 3.1.30, created on 2018-05-07 18:13:22
  from "/var/www/html/smarty/templates/print/pages/pricebookny.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5af09742692f35_08346442',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '26993242db6779a95c5c8a8f28a1b2ece1d80ff9' => 
    array (
      0 => '/var/www/html/smarty/templates/print/pages/pricebookny.tpl',
      1 => 1523659342,
      2 => 'file',
    ),
  ),
...
function content_5af09742692f35_08346442 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_date_format')) require_once '/var/www/Smarty/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) require_once '/var/www/Smarty/libs/plugins/function.math.php';
?>
<div id="pricebook">
...
<span class="bld">1 cs(<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['case'];?>
)|1 btl.:</span> $<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['frontline_case'];?>
|$<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['frontline'];?>

<?php } else { ?>
<span class="bld">1 bottle:</span> $<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['frontline'];?>

<?php }
if ($_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['discount3'] > 0) {?>
<br><span class="bld">3 cs(<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['case'];?>
)|1 btl.:</span> $<?php echo smarty_function_math(array('equation'=>"x * y",'x'=>$_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['discount3'],'y'=>$_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['case'],'format'=>"%.2f"),$_smarty_tpl);?>
|$<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['discount3'];?>

<?php }
if ($_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['discount5'] > 0) {?>
<br><span class="bld">5 cs(<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['case'];?>
)|1 btl.:</span> $<?php echo smarty_function_math(array('equation'=>"x * y",'x'=>$_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['discount5'],'y'=>$_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['case'],'format'=>"%.2f"),$_smarty_tpl);?>
|$<?php echo $_smarty_tpl->tpl_vars['vintages']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_bit']->value['index'] : null)]['discount5'];?>
