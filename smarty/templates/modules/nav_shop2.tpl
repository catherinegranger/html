...
<li><a  href="/wines2/all/" title="Shop All"><span {if $search_all}class="on"{/if}>Shop All</span></a></li>
...
<li {if $wine_types[bit].web_name == $search_criteria} class="active"{/if}><a href="/wines2/{$wine_types[bit].web_name}/" title="Shop {$wine_types[bit].full_name}">{$wine_types[bit].full_name}</a></li>
{/section}
</ul><!-- /#winetypes -->
...
<li {if $wine_styles[bit].web_name == $search_criteria} class="active"{/if}><a href="/wines2/{$wine_styles[bit].web_name}/" title="Shop {$wine_styles[bit].full_name}">{$wine_styles[bit].full_name}</a></li>
{/section}
</ul><!-- /#winestyles -->
...
<li {if $ncc[bit].web_name == $search_criteria} class="active"{/if}><a href="/wines2/{$ncc[bit].web_name}/" title="Shop {$ncc[bit].full_name}">{$ncc[bit].full_name}</a></li>
{/section}
</ul><!-- /#regions -->
...
<li {if $varietals[bit].web_name == $search_criteria} class="active"{/if}><a href="/wines2/{$varietals[bit].web_name}/" title="Shop {$varietals[bit].full_name}">{$varietals[bit].full_name}</a></li>
{/section}
</ul><!-- /#varietals -->
</ul><!-- /.menu-list -->
</div><!-- /.menu-content -->
