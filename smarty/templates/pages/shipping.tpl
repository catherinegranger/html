...
<p>
<b>Estimated shipping costs plus ${$adult_signature} Adult Signature for each order</b>
...
<p>
If you indicate that your order is a gift, the packing list we include in the package will have no price information. You can also purchase from us a greeting card for ${$greeting_card}. Please enter your gift message in the "Personalised Message" text area of your order.</p>
...
{assign var=head_title value='Shipping Policies'}</p>
