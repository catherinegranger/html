{include file="modules/nav_shop2.tpl"}
...
{if TRUE}
Never pay for shipping again! Join Club Vino Danubia and get free shipping when you order 6 or 12 bottles. Join <a href="/wineclub/">here</a>.
{/if}
{if FALSE}
...
<h2 title="New Arrivals"><a href="/wines2/new/" title="New Arrivals">New Arrivals</h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/new/" title="More New Arrivals"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
...
<h2 title="Special offers"><a href="/wines2/specials/" title="Special Offers">Special Offers</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/specials/" title="More Special Offers"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Organic Wines"><a href="/wines2/organic/" title="Organic Wines">Organic Wines</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/organic/" title="More Organic"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Wines from Austria"><a href="/wines2/austria/" title="Wines from Austria">Wines from Austria</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/austria/" title="More Wines from Austria"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Wines from Bosnia"><a href="/wines2/bosnia_herzegovina/" title="Wines from Bosnia Herzegovina">Wines from Bosnia Herzegovina</A></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/bosnia_herzegovina/" title="More Wines from Bosnia Herzegovina"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
{/if}
<a href="/wines2/{$country_name|lower}/" title="Wines from {$country_name}">{$country_name}</a></h2>
...
<h2 title="Wines from Croatia"><a href="/wines2/croatia/" title="Wines from Croatia">Wines from Croatia</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/croatia/" title="More Wines from Croatia"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Wines from Georgia"><a href="/wines2/georgia/" title="Wines from Georgia">Wines from Georgia</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/georgia/" title="More Wines from Georgia"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Wines from Hungary"><a href="/wines2/hungary/" title="Wines from Hungary">Wines from Hungary</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/hungary/" title="More Wines from Hungary"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Wines from Slovenia"><a href="/wines2/slovenia/" title="Wines from Slovenia">Wines from Slovenia</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/slovenia/" title="More Wines from Slovenia"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Multi-Producer Samplers"><a href="/wines2/samplers/" title="Multi producer samplers">Gift Sets &mdash; Multi Producers</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/samplers/" title="More Samplers}"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
...
<h2 title="Magnums"><a href="/wines2/magnums/" title="Magnums">Big Bottles</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/magnums/" title="More Magnums"><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
</div><!-- /.mod_bottle_info_text_buy -->
</div><!-- /.mod_bottle_info_text -->
</div><!-- /.mod_bottle_info -->
</form>
...
<h2 title="Other Items"><a href="/wines2/others/" title="Books and Misc.">Books and Misc.</a></h2>
...
<button class="btn btn-xs btn-primary" type="submit" title="Add to Cart">Add to Cart</button>  {if $smarty.section.bit.last && ($search_criteria == "all")} <a href="/wines2/others/" title="More Books & Misc."><span class="right_arrow fa-2x"><i class="fa fa-chevron-right" fa-5x"></i></span></a>{/if}
...
{if $search_by_country}
{assign var=head_title value='Shop Online - Buy Wines from '|cat:$wines.0.country}
...
{assign var=head_title value='Shop Online - Buy '|cat:$re_search_criteria|cat:' Wines'}
{assign var=head_desc value='Finest selection of '|cat:$re_search_criteria|cat:' Wines. Blue Danube Wine imports wines from Austria, Bosnia Herzegovina, Croatia, Georgia, Hungary, Montenegro, and Slovenia to buy and distribute in the United States.'}
{/if}
