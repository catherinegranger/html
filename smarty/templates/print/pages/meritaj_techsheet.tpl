...
<p class="top_paragraph"><span class="big_red">{$first_letter}</span>{$introduction}
</p>
{if $vineyards}
<h3>VINEYARDS</h3>
<p>{$vineyards}
...
Imported by: MERITAJ
<br><span class="meritaj_red">meritaj.com</span>
<br>order@meritaj.com
<br><span class="meritaj_red">facebook.com/GuldalSomm</span>
<br><span class="meritaj_red">twitter.com/GuldalSomm</span>
</div>
</div>