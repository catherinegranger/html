...
{if $vintages[bit].producer_webname == 'doqi' || $vintages[bit].producer_webname == 'fekete'  || $vintages[bit].producer_webname == 'heimann'  || $vintages[bit].producer_webname == 'kreinbacher'  || $vintages[bit].producer_webname == 'torley'}
<div style="font-size:0.5em;page-break-before: always;page-break-after: avoid;">&nbsp;</div>
{/if}
