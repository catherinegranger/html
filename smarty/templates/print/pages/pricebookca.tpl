...
<span class="bld">Frontline:</span> ${$vintages[bit].frontline}
{if $vintages[bit].case}
<br><span class="bld">One case ({$vintages[bit].case}):</span> ${$vintages[bit].frontline_case}
{/if}
