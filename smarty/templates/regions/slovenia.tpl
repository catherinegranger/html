<h2 class="region_subheader">Sitting at the crossroads of many an empire and country that has come and gone, Slovenia has been quietly making high-class wines for over two millenia with many of the current wineries founded as far back as the 1500's.</h2>

<p>
<center><img id="region_map" src="/img/regions/slovenia_map.jpg" alt="Slovenian Wine Regions" usemap="#sloveniamap"/><div id="region_map_descr">Click on the winery's number to navigate to the winery page.</div></center>
...
<div class="alignCenter  winery_caption some_space2"><img src="/img/wineries/crnko_vineyard.jpg" alt="Slovenian Hills" class="winery_postcardcenter" /><br>Črnko Vineyard near Maribor</div>

<h2 class="region_subheader">Regions &amp; Wines</h2>
<p>
...
<h2 class="region_subheader">Learn more about Slovenia</h2>
<p>

<span style="vertical-align:20px;margin-right:4px;"><a href="/pdf/Slovenian_Wine_Routes.pdf" target="_blank">Slovenian Wine Routes Brochure</a></span>
<img  style="position:relative;top:-6px;" src="/img/all/pdficon_large.png" alt="PDF icon" />

</p>


{assign var=head_title value="Slovenian Wines"}