...
if ($two == 'price_posting') {
  $filename = $file_dir."../../../reports/bdw_price_posting.csv";
  $report_url = "https://bluedanubewine.com/reports/bdw_price_posting.csv";
}
...
if ($two == 'solve_reports') {
  ...
  $last_year = mktime(0, 0, 0, 1, 1, $previousyear);
  ...
  $sql .= " WHERE o.rec_id = r.rec_id AND o.status != '0'  AND o.placed > ".$last_year." AND o.status != '4' AND o.status != '1' AND o.status != '7' AND o.status != '8'  AND r.state = 'NY' ORDER BY r.rec_id DESC";
  ...
  $monthly_sql .= " WHERE o.rec_id = r.rec_id AND o.placed > ".$last_year." AND r.state = 'NY' ORDER BY r.rec_id DESC";
