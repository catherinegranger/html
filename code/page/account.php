...
$account = array('user_id' => $userDetails['id'], 
		 ...
		 'subscription_expiration_date' => $userDetails['subscription_expiration_date'],
		 'subscription_message' => $userDetails['subscription_message'],
		 'subscription_referral_type' => $userDetails['subscription_referral_type'],
...
$sql .= " o.instructions, o.need_by_date, o.include_card, o.include_card_cost, o.include_card_msg, o.tax, o.shipping, o.adult_signature, o.shipping_method, o.payment_method, o.status, o.status_timestamp, o.giftcard_id, o.giftcard_total, o.discount_id, o.discount_total, o.grand_total, o.cart_total, ";
