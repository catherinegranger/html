...
$sql .= " WHERE country_code.c_id = winery.c_id AND type.type_id = vintage.type_id AND vintage.wy_id = winery.wy_id AND vintage.ca_wholesale_price > 0  AND at_event > 0 AND vintage.inactive = 0 AND vintage.deleted = 0";
