...
$introduction = strip_tags_content($row['introduction']);
...
$vineyards = strip_tags_content($row['vineyards']);
$smarty->assign('vineyards', $vineyards);
$winemaking = strip_tags_content($row['winemaking']);
$smarty->assign('winemaking', $winemaking);
//$winemaking = strip_tags_content($row['winemaking2']);
$smarty->assign('winemaking2', $row['winemaking2']);
