...
define('BDW_SHIP_STATES', 'Arizona, California, District of Columbia, Idaho, Louisiana, Minnesota, Nebraska, New Mexico, Nevada, North Dakota, Oregon,  Virginia, West Virginia, Wisconsin, Wyoming.');
define('BDW_NO_SHIP_STATES', 'Alabama, Alaska, Arkansas, Colorado, Connecticut, Delaware, Florida, Georgia, Hawaii, Illinois, Indiana, Iowa, Kansas, Kentucky, Maine, Maryland, Massachusetts, Michigan,  Mississipi, Missouri, Montana, New Hampshire, New Jersey, New York, North Carolina, Ohio, Oklahoma, Pennsylvania, Rhode Island, South Carolina, South Dakota, Tennessee, Texas, Utah, Vermont, Washington.');
...
$shipping_states = array('AZ', 'CA','DC', 'ID','LA',
                           'MN', 'NE', 'NV','NM','ND','OR', 'VA','WV','WI','WY');
